            ...
            <div class="container">
               <div class="row">
                  <div class="col-12 d-flex justify-content-between justify-content-md-between  align-items-center flex-md-row flex-column">
                     <h3 class="breadcrumb-title">{{ __('Vehicle Details') }}</h3>
                     <div class="breadcrumb-nav">
                        <nav aria-label="breadcrumb">
                           <ul>
                              <li><a href="{{url('/')}}">{{ __('Home') }}</a></li>
                              <li><a href="{{url('/web/vehicle')}}">{{ __('Vehicle') }}</a></li>
                              <li class="active" aria-current="page">{{ __('Vehicle Details') }} </li>
                           </ul>
                        </nav>
                     </div>
                  </div>
...
<!-- ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
                  ...
                  <div class="product-details-content-area" data-aos="fade-up"  data-aos-delay="200">
                    ...
                    @endif
                     ...
                     <table style="width: 100%;">
                        <tr>
                           <th class="partsummery">Vehicle Summery</th>
        ...
        <tr>
            <td ><input style="background-color: #ccc;" @if($product->option1=="Push start") checked @endif type="radio" name="option1" value="Push start">
                <label for="html">Push Start</label></td>
            <td   class="optiontext">
                <input @if($product->option10=="ABS") checked @endif type="radio" name="option10" value="ABS">
                <label for="html">ABS</label>
            </td>
        ...
        <tr>
            <td   class="optiontext">
                <input  @if($product->option2=="Safety package") checked @endif type="radio" name="option2" value="Safety package" disabled>
                <label for="html">Safety Package</label></td>
            <td   class="optiontext"><input @if($product->option3=="Multi-function") checked @endif type="radio" name="option3" value="Multi-function" disabled>
                <label for="html">Multi-funtion</label></td>

        </tr>
        <tr>
            <td   class="optiontext"><input @if($product->option12=="Turbo") checked @endif type="radio" name="option12" value="Turbo" disabled>
                <label for="html">Turbo</label></td>
            <td   class="optiontext"><input @if($product->option4=="Air condition") checked @endif type="radio" name="option4" value="Air condition" disabled>
                <label for="html">Air Condition</label></td>

        </tr>
    
        <tr>
            <td   class="optiontext"><input @if($product->option13=="Power steering") checked @endif type="radio" name="option13" value="Power steering" disabled>
                <label for="html">Power Steering</label></td>
            <td   class="optiontext"><input @if($product->option5=="Power mirror") checked @endif  type="radio" name="option5" value="Power mirror" disabled>
                <label for="html">Power Mirror</label></td>

        </tr>
        <tr>
            <td   class="optiontext"><input @if($product->option14=="Power window") checked @endif type="radio" name="option14" value="Power window" disabled>
                <label for="html">Power Window</label></td>
            <td   class="optiontext"><input @if($product->option6=="Power door") checked @endif type="radio" name="option6" value="Power door" disabled>
                <label for="html">Power Door</label></td>

        </tr>
        <tr>
            <td   class="optiontext"><input @if($product->option7=="4x4 system") checked @endif type="radio" name="option7" value="4x4 system" disabled>
                <label for="html">4x4 System</label></td>

            <td   class="optiontext"><input @if($product->option16=="Alloy wheels") checked @endif type="radio" name="option16" value="Alloy wheels" disabled>
                <label for="html">Alloy Wheels</label></td>

        </tr>    <tr>
            <td   class="optiontext"><input @if($product->option15=="Player & Camera") checked @endif type="radio" name="option15" value="Player & Camera" disabled>
                <label for="html">Player & Camera</label></td>
            <td   class="optiontext"><input @if($product->option8=="Original flow carpet") checked @endif type="radio" name="option8" value="Original flow carpet" disabled>
                <label for="html">Original flow carpet</label></td>

        </tr>  <tr>
            <td   class="optiontext"><input @if($product->option9=="Door wiser") checked @endif type="radio" name="option9" value="Door wiser" disabled>
                <label for="html">Door wiser</label></td>
            ...
            <div class="moreads">
               <p style = 'line-height: 20px'>
                  <img class="circular--landscape" src="{{asset('/')}}image/shop/{{$product->logo}}"  style='vertical-align: middle' /> &nbsp; More ads from <a href= " ">  {{$product->shopName}}</a>
               </p>
            </div>
