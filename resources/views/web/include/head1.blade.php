<head>
    ...
    <title>Dothalu.lk</title>

    <!-- ::::::::::::::Favicon icon::::::::::::::-->
    <link rel="shortcut icon" href="{{asset('/')}}assetss/images/apple-icon.png" type="image/png">
    ...
    <!-- <link rel="stylesheet" href="../../../assetss/css/vendor/vendor.min.css">
    <link rel="stylesheet" href="../../../assetss/css/plugins/plugins.min.css">
    <link rel="stylesheet" href="../../../assetss/css/style.min.css"> -->
    <!-- sweetalert -->
