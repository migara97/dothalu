					...
					<div class="row d-flex justify-content-between align-items-center">
						...
						<div class="col-9">
							...
							<div class="header-search">
								<form action="/allsearchparts" method="post">
								@csrf
									<div class="header-search-box default-search-style d-flex">
										<input class="default-search-style-input-box border-around border-right-none" name="fullsearch" type="search" placeholder="Search entire store here ..." required>
...
// var footer_top = jQuery(".footer-section").offset().top;
...
function myFunction() {
  if (window.pageYOffset > sticky) {
	...
	// $(".filtering-part").css("overflow-y","scroll");
	// $(".filtering-part").css("height","953px");
	...
	$(".sidebar").css("margin-top","140px");
	$(".sidebar").css("overflow-y","scroll");

	
	$(".bannerimage").css("width","85%");
	$(".bannerimage").css("margin-left","15%");
	
	$(".breadcrumb-title").css("margin-left","140px");

	$("#footer").css("width","90%");
	$("#footer").css("margin-left","12%");
	// $(".footer-top").css("position","static");
	// $(".footer-bottom").css("position","fixed");
	// $(".footer-bottom").css("background-color","red");
	
  } else {
    header.classList.remove("sticky");
	$(".sidebar").css("margin-top","33%");
	$(".sidebar").css("position","absolute");
	$(".mainheaderbg").css("background-color","#fff");
	$(".mainheaderbg").css("color","#000");
	$(".textcolor").css("color","#000");
	$(".bannerimage").css("width","100%");
	$(".bannerimage").css("margin-left","0px");
  }
}
