            ...
            <div class="row">
                        ...
                        <div class="contact-details">
                            ...
                            <div class="contact-details-single-item">
                                ...
                                <div class="contact-details-content contact-phone">
                                    <a href="tel:+0710 45 45 45">0710 45 45 45</a>
                                    <a href="tel:+0710 45 45 46">0710 45 45 46</a>
                                </div>
                            ...
                            <div class="contact-details-single-item">
                                ...
                                <div class="contact-details-content contact-phone">
                                    <a href="mailto:urname@email.com">info@dothalu.lk</a>
                                    <a href="http://www.Dothalu.com">www.Dothalu.com</a>
                                </div>
                            </div> <!-- End Contact Details Single Item -->
                            <!-- Start Contact Details Single Item -->
                            <div class="contact-details-single-item">
                ...
                <div class="col-lg-8">
                    <div class="contact-form section-top-gap-100" data-aos="fade-up"  data-aos-delay="200">
                        <h3>Get In Touch</h3>
                        <form id="contact-form" action="../assetss\mail\contact.php" method="POST">
                            <div class="row">
                                <div class="col-lg-6">
