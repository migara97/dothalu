				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Web User</span> - Edit</h4>
						</div>
				...
				<div class="content">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<!-- Basic layout-->
							<form action="/updateWebuser" method="POST">
                            @csrf
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Web User</h5>
                                    ...
                                    <div class="panel-body">
										<div class="form-group">
											...
											<label>Web User Email:</label>
											<input type="email" class="form-control" name="email" value="{{$webuser->name}}" placeholder="Enter User Name">
										</div>
