				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Category</span> - Edit</h4>
						</div>
								...
								<div class="panel panel-flat">
									...
									<div class="panel-body">
                                        ...
                                        <input type="hidden" name="id" id="id" value="{{$category->id}}">
											...
											<input type="text" class="form-control" value="{{$category->title}}" name="category" placeholder="Enter Category Name" required>
										</div>
