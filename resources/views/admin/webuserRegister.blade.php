				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Web User</span> - Add</h4>
						</div>
				...
				<div class="content">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<!-- Basic layout-->
							<form action="/saveWebuser" method="POST">
                            @csrf
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Web Register</h5>
